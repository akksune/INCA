...
const saveFlashcardsToLocal = () => {
  ...
  if (tempQuestion && tempAnswer) {
    ...
    console.log("Flashcards saved to local storage:", flashcards); // Log the saved flashcards
  } else {
...
window.addEventListener("load", () => {
  ...
  flashcards.forEach((card) => {
    ...
    // saveFlashcardsToLocal(); // Remove this line
  });
});
...
// Event listener for the "Delete All Flashcards" button
const deleteAllFlashcardsButton = document.getElementById(
  "delete-all-flashcards"
);
deleteAllFlashcardsButton.addEventListener("click", deleteAllFlashcards);
